...
The application uses a single-file architecture where `index.js` (7,304 lines) contains the Express server, routes, and inline HTML, CSS, and JavaScript. No build step; relies on plain Node.js and Express.
